...
#include <k4a_sample_helper/BodyTrackingHelpers.h>
#include <k4a_sample_helper/Utilities.h>
...
int OfflineProcessor::Run()
{
	cout << "Usage: k4abt_offline_processor.exe <input_mkv_file> <output_json_file>" << endl;

	const char* mkv_path = "C:\\Users\\Administrator\\Downloads\\output1.mkv";
	const char* json_path = "temp.json";
	return process_mkv_offline(mkv_path, json_path) ? 0 : -1;
}
